// crown_test_op_hybrid.cu - 하이브리드 최적화 테스트
// matmul만 GPU(cuBLAS), 나머지 전부 CPU
// 컴파일: nvcc -Xcompiler "/utf-8" -Xlinker "/STACK:134217728" -arch=sm_89 -lcublas crown_test_op_hybrid.cu -o crown_test_op_hybrid.exe

#include<iostream>
#include<cuda_runtime.h>
#include<vector>
#include<chrono>
#include "my_lirpa_op_hybrid.cu"
#include<fstream>
...
int main(int argc, char** argv){
    ...
    std::cout << "=== HYBRID CROWN Test (matmul=cuBLAS, rest=CPU) ===" << std::endl;
    ...
    std::cout << "  ** MODE: HYBRID (matmul=GPU, rest=CPU) **" << std::endl;
    std::cout << "========================================\n";
